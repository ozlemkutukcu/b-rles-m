<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="bırlesım.Default" %>
			...
			<header id="header">
				<div class="inner">
					...
					<nav id="nav">
						...
						<a href="login.aspx">Log in/Sign up</a>
						<a href="elements.html">Set up my business</a>
					</nav>
				</div>
			</header>
